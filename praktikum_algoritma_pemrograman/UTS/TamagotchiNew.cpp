...
int play(){ //function untuk memberi nama peliharaan dan mengarah ke pet
	...
	scanf("%[^\n]", *&name);fflush(stdin); //Fungsinya adalah untuk membersihkan (atau flush) output buffer dan memindahkan data buffer menuju console (dalam kasus stdout) atau disk (pada kasus file output stream)
